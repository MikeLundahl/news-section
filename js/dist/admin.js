...
flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().initializers.add('mbl/news-section', function () {
  console.log('[mbl/news-section] Hello, admin!');
  flarum_admin_app__WEBPACK_IMPORTED_MODULE_0___default().extensionData["for"]('mbl-news-section').registerSetting({
